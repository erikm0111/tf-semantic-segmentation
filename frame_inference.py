...
if __name__ == '__main__':
    ...
    output_dir = '/home/ematosevic/CompSci/projects_repo/tf-semantic-segmentation/output_frames/'
    ...
    with tf.Session() as sess:
        ...
        for i in range(NUM_EPOCHS):
            ...
            print colored("Done {}/{}".format((i+1)*NUM_FRAMES_IN_EPOCH, NUM_FRAMES_IN_EPOCH*NUM_EPOCHS),'yellow')
